...
class QuestionBase(BaseModel):
    ...
    professor_name: str = Field(..., min_length=2, max_length=100)
    serie_ano: str = Field(..., min_length=2, max_length=50)
    phase_level: str = Field(..., min_length=2, max_length=50)
    difficulty_level: DifficultyLevel
    bncc_theme: str = Field(..., min_length=2, max_length=200)
    knowledge_objects: str = Field(..., min_length=10)
    ability_code: str = Field(..., min_length=3, max_length=20)
    ability_description: str = Field(..., min_length=10)
    question_statement: str = Field(..., min_length=20)
    alternatives: str = Field(..., min_length=50)
    correct_alternative: str = Field(..., min_length=1, max_length=10)
    detailed_resolution: str = Field(..., min_length=20)
...
class QuestionUpdate(BaseModel):
    ...
    professor_name: Optional[str] = Field(None, min_length=2, max_length=100)
    serie_ano: Optional[str] = Field(None, min_length=2, max_length=50)
    phase_level: Optional[str] = Field(None, min_length=2, max_length=50)
    difficulty_level: Optional[DifficultyLevel] = None
    bncc_theme: Optional[str] = Field(None, min_length=2, max_length=200)
    knowledge_objects: Optional[str] = Field(None, min_length=10)
    ability_code: Optional[str] = Field(None, min_length=3, max_length=20)
    ability_description: Optional[str] = Field(None, min_length=10)
    question_statement: Optional[str] = Field(None, min_length=20)
    alternatives: Optional[str] = Field(None, min_length=50)
    correct_alternative: Optional[str] = Field(None, min_length=1, max_length=10)
    detailed_resolution: Optional[str] = Field(None, min_length=20)
    latex_formula: Optional[str] = Field(None, max_length=2000)
...
class QuestionResponse(QuestionBase, TimestampedSchema):
    """Schema para resposta de questão."""
